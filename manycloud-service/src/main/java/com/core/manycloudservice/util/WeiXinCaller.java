...
public class WeiXinCaller {
    ...
    public static void main(String[] args){
        ...
        api = api.replace("{appid}","wx3268be6fdfff1bc3").replace("{secret}","283c04b81f2cd70a440fd6743c61b333");
    ...
    public String getAccessToken(String appid,String secret){
        ...
        String str = HttpRequest.sendGet(apiUrl+api);
